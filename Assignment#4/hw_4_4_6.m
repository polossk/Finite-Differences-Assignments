...
%%%
%% Numerical Solution(Wrong Scheme, Comparing with HW 4.4.7)
%%%
ts = [0.06, 0.1, 0.9];
dx = 0.05; dy = 0.05; dt = 0.01;
[u, X, Y] = solver_4_4_6(dx, dy, dt);
plotSlice_4_4_3(ts, dt, u, X, Y);

%% Code: Solver of Functionn
%%%
%
%   function [u, X_, Y_] = solver_4_4_6( dx, dy, dt )
...
%           coef_Right_Hand = u_ * coef_inv_mrdx2;
